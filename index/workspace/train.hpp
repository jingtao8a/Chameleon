...
//            auto weight_tensor = torch::tensor({random_memory_weight(),random_height_weight()}).view({1,2});
//            weight_tensor = weight_tensor.mul(torch::ones({BATCH_SIZE,2}));
//            weight_tensor = weight_tensor.to(GPU_DEVICE);
